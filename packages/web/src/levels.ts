...
export const testRoom = (offset: number) => [
  ...
  { position: [0, 8, offset + 0], type: "checkpoint", rotation: [0, 0, 0] },
  { position: [0, 8, offset + 0], type: "checkpoint", rotation: [0, 0, 0] },
  {
    type: "platform-section",
    position: [0, 6, offset + 0],
    scale: [15, 0.3, 1],
    rotation: [0, 0, 0, "XYZ"],
    oneWay: true,
  },
  ...
  {
    position: [-8, offset + 6, 0],
    scale: [1, 14, 1],
    type: "platform",
    rotation: [0, 0, 0],
  },
  {
    position: [8, 6, offset + 0],
    scale: [1, 14, 1],
    type: "platform",
    rotation: [0, 0, 0],
  },
  {
    position: [0, -1, offset + 0],
    scale: [17, 1, 1],
    type: "platform",
    rotation: [0, 0, 0],
  },
  {
    position: [-8, offset + 15.5, 0],
    scale: [1, 33, 1],
    type: "platform",
    rotation: [0, 0, 0],
  },
  ...
  {
    position: [8, 36, offset + 0],
    scale: [1, 8, 1],
    type: "platform",
    rotation: [0, 0, 0],
  },
  {
    position: [0, 40, offset + 0],
    scale: [17, 1, 1],
    type: "platform",
    rotation: [0, 0, 0],
  },
